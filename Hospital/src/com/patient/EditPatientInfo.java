...
public class EditPatientInfo {
	public static int update(Patient p) {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("update patient set patient_name=?,email=?,password=?,address=?,phone=?,sex=?,blood_group=? where patient_id=?");
